...
function Dashboard() {
  ...
  const recentRides = [
    { id: 1, date: '2025-01-15', route: 'Hitech City → Airport', fare: '₹350', status: 'Completed' },
    { id: 2, date: '2025-01-14', route: 'Forum Mall → Home', fare: '₹220', status: 'Completed' },
    { id: 3, date: '2025-01-13', route: 'Office → Restaurant', fare: '₹180', status: 'Completed' }
  ];
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  {vehicleTypes.map((vehicle) => (
                    <div
                      ...
                      onClick={() => setBookingData(prev => ({ ...prev, vehicleType: vehicle.name }))}
                    >
                      <div className="flex items-center justify-between mb-2">
                        <Car className="w-6 h-6 text-gray-600" />
                        <span className="text-lg font-bold text-purple-600">₹{vehicle.price}</span>
                      </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6">
            ...
            <div className="bg-gradient-to-br from-gray-100 to-gray-200 rounded-xl h-64 flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-gray-500">Map will appear here when you book a ride</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6">
            <div className="flex items-center justify-between mb-6">
              ...
              <a href="/history" className="text-purple-600 hover:text-purple-700 font-medium flex items-center">
                View All
            ...
            <div className="space-y-3">
              {recentRides.map((ride) => (
                <div key={ride.id} className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
        ...
        <div className="space-y-6">
          ...
          {/* Estimated Fare */}
          <div className="bg-white rounded-2xl shadow-lg p-6">
            <h3 className="text-lg font-bold text-gray-900 mb-4">Estimated Fare</h3>
            <div className="space-y-3">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6">
            ...
            <div className="bg-gray-100 p-3 rounded-xl text-center mb-3">
              <code className="font-mono font-bold text-purple-600">VR2025FRIEND</code>
            </div>
